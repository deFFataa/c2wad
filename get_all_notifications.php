    ...
    <div class="section-3 p-2 mb-1 mt-4">
        <div class="profile-box">
            <div class="container mt-3">
                <div class="row">
                    <p class="h5 mt-2" style="color: #ff702d;">All Notifications</p>
                    <?php
                    $user_id = $_SESSION['user_id'];

                    $notification_sql = "SELECT * FROM notifications WHERE status = 'Read' AND user_id = '$user_id' ORDER BY id DESC";
